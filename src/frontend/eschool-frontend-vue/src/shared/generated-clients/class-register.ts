...
export class AbsencesClient {
    ...
    listLessonAbsences(lessonId: string, pageSize: number | undefined, pageIndex: number | undefined , cancelToken?: CancelToken | undefined): Promise<PagedListResponseOfLessonAbsenceListResponse> {
        ...
        return this.instance.request(options_).catch((_error: any) => {
            ...
            return this.processListLessonAbsences(_response);
        });
    }

    protected processListLessonAbsences(response: AxiosResponse): Promise<PagedListResponseOfLessonAbsenceListResponse> {
        ...
        if (status === 200) {
            ...
            result200 = PagedListResponseOfLessonAbsenceListResponse.fromJS(resultData200);
            return result200;
        } else if (status === 400) {
            const _responseText = response.data;
        ...
        return Promise.resolve<PagedListResponseOfLessonAbsenceListResponse>(<any>null);
    }

    listLessonAbsences2(lessonId: string, pageSize: number | undefined, pageIndex: number | undefined, schoolYearId: string, classId: string, subjectId: string , cancelToken?: CancelToken | undefined): Promise<PagedListResponseOfLessonAbsenceListResponse> {
        let url_ = this.baseUrl + "/api/school-years/{schoolYearId}/classes/{classId}/subjects/{subjectId}/lessons/{lessonId}/absences?";
        if (lessonId === undefined || lessonId === null)
            throw new Error("The parameter 'lessonId' must be defined.");
        url_ = url_.replace("{lessonId}", encodeURIComponent("" + lessonId));
        ...
        return this.instance.request(options_).catch((_error: any) => {
            ...
            return this.processListLessonAbsences2(_response);
        });
    }

    protected processListLessonAbsences2(response: AxiosResponse): Promise<PagedListResponseOfLessonAbsenceListResponse> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
...
export class ClassesClient {
    ...
    listStudents(id: string, searchText: string | null | undefined, pageSize: number | undefined, pageIndex: number | undefined , cancelToken?: CancelToken | undefined): Promise<PagedListResponseOfUserRoleListResponse> {
...
export class ParentsClient {
    ...
    listParents(pageSize: number | undefined, pageIndex: number | undefined , cancelToken?: CancelToken | undefined): Promise<PagedListResponseOfUserRoleListResponse> {
        ...
        return this.instance.request(options_).catch((_error: any) => {
            ...
            return this.processListParents(_response);
        });
    }

    protected processListParents(response: AxiosResponse): Promise<PagedListResponseOfUserRoleListResponse> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
    ...
    listStudentsOfParent(parentId: string , cancelToken?: CancelToken | undefined): Promise<UserRoleListResponse[]> {
        let url_ = this.baseUrl + "/api/parents/{parentId}/students";
        ...
        return this.instance.request(options_).catch((_error: any) => {
            ...
            return this.processListStudentsOfParent(_response);
        });
    }

    protected processListStudentsOfParent(response: AxiosResponse): Promise<UserRoleListResponse[]> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
    ...
    assignParentToStudent(parentId: string, studentId: string , cancelToken?: CancelToken | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/parents/{parentId}/students/{studentId}";
        if (parentId === undefined || parentId === null)
            throw new Error("The parameter 'parentId' must be defined.");
        url_ = url_.replace("{parentId}", encodeURIComponent("" + parentId));
        if (studentId === undefined || studentId === null)
        ...
        return this.instance.request(options_).catch((_error: any) => {
            ...
            return this.processAssignParentToStudent(_response);
        });
    }

    protected processAssignParentToStudent(response: AxiosResponse): Promise<void> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
    ...
    removeParentFromStudent(parentId: string, studentId: string , cancelToken?: CancelToken | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/parents/{parentId}/students/{studentId}";
        if (parentId === undefined || parentId === null)
            throw new Error("The parameter 'parentId' must be defined.");
        url_ = url_.replace("{parentId}", encodeURIComponent("" + parentId));
        ...
        return this.instance.request(options_).catch((_error: any) => {
            ...
            return this.processRemoveParentFromStudent(_response);
        });
    }

    protected processRemoveParentFromStudent(response: AxiosResponse): Promise<void> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
...
export class RecipientGroupsClient {
    ...
    listRecipientGroupMembers(recipientGroupId: string , cancelToken?: CancelToken | undefined): Promise<ClassRegisterUserListResponse[]> {
    ...
    protected processListRecipientGroupMembers(response: AxiosResponse): Promise<ClassRegisterUserListResponse[]> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(ClassRegisterUserListResponse.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
        ...
        return Promise.resolve<ClassRegisterUserListResponse[]>(<any>null);
    }
...
export class StudentsClient {
    ...
    listStudents(searchText: string | null | undefined, pageSize: number | undefined, pageIndex: number | undefined , cancelToken?: CancelToken | undefined): Promise<PagedListResponseOfUserRoleListResponse> {
    ...
    listLessons(studentId: string, schoolYearId: string, subjectId: string, pageSize: number | undefined, pageIndex: number | undefined , cancelToken?: CancelToken | undefined): Promise<PagedListResponseOfLessonListResponse> {
        let url_ = this.baseUrl + "/api/students/{studentId}/school-years/{schoolYearId}/subjects/{subjectId}/lessons?";
        if (studentId === undefined || studentId === null)
            throw new Error("The parameter 'studentId' must be defined.");
        url_ = url_.replace("{studentId}", encodeURIComponent("" + studentId));
        if (schoolYearId === undefined || schoolYearId === null)
...
export class UsersClient {
    ...
    listUsers(searchText: string | null | undefined, pageSize: number | undefined, pageIndex: number | undefined , cancelToken?: CancelToken | undefined): Promise<PagedListResponseOfClassRegisterUserListResponse> {
    ...
    protected processListUsers(response: AxiosResponse): Promise<PagedListResponseOfClassRegisterUserListResponse> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200  = _responseText;
            result200 = PagedListResponseOfClassRegisterUserListResponse.fromJS(resultData200);
            return result200;
        } else if (status === 400) {
            const _responseText = response.data;
            let result400: any = null;
        ...
        return Promise.resolve<PagedListResponseOfClassRegisterUserListResponse>(<any>null);
    }
}
...
export class PagedListResponseOfLessonAbsenceListResponse implements IPagedListResponseOfLessonAbsenceListResponse {
    pageSize!: number;
    pageIndex!: number;
    totalCount!: number;
    items!: LessonAbsenceListResponse[] | undefined;

    constructor(data?: IPagedListResponseOfLessonAbsenceListResponse) {
        if (data) {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items!.push(LessonAbsenceListResponse.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedListResponseOfLessonAbsenceListResponse {
        data = typeof data === 'object' ? data : {};
        let result = new PagedListResponseOfLessonAbsenceListResponse();
        result.init(data);
        return result;
    }
...
export interface IPagedListResponseOfLessonAbsenceListResponse {
    pageSize: number;
    pageIndex: number;
    totalCount: number;
    items: LessonAbsenceListResponse[] | undefined;
...
export class LessonAbsenceListResponse implements ILessonAbsenceListResponse {
    id!: string;
    absenceState!: AbsenceState;
    student!: UserRoleListResponse | undefined;

    constructor(data?: ILessonAbsenceListResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): LessonAbsenceListResponse {
        data = typeof data === 'object' ? data : {};
        let result = new LessonAbsenceListResponse();
        result.init(data);
        return result;
    }
...
export interface ILessonAbsenceListResponse {
    id: string;
    absenceState: AbsenceState;
    student: UserRoleListResponse | undefined;
}
...
export class PagedListResponseOfClassRegisterUserListResponse implements IPagedListResponseOfClassRegisterUserListResponse {
    pageSize!: number;
    pageIndex!: number;
    totalCount!: number;
    items!: ClassRegisterUserListResponse[] | undefined;

    constructor(data?: IPagedListResponseOfClassRegisterUserListResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(ClassRegisterUserListResponse.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedListResponseOfClassRegisterUserListResponse {
        data = typeof data === 'object' ? data : {};
        let result = new PagedListResponseOfClassRegisterUserListResponse();
        result.init(data);
        return result;
    }
...
export interface IPagedListResponseOfClassRegisterUserListResponse {
    pageSize: number;
    pageIndex: number;
    totalCount: number;
    items: ClassRegisterUserListResponse[] | undefined;
