...
export class HomeAssignmentsSchoolYearsClient {
    ...
    listSchoolYearsOfStudent(  cancelToken?: CancelToken | undefined): Promise<ClassRegisterItemResponse[]> {
    ...
    protected processListSchoolYearsOfStudent(response: AxiosResponse): Promise<ClassRegisterItemResponse[]> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(ClassRegisterItemResponse.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
        ...
        return Promise.resolve<ClassRegisterItemResponse[]>(<any>null);
    }

    listSchoolYearsOfTeacher(  cancelToken?: CancelToken | undefined): Promise<ClassRegisterItemResponse[]> {
    ...
    protected processListSchoolYearsOfTeacher(response: AxiosResponse): Promise<ClassRegisterItemResponse[]> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
